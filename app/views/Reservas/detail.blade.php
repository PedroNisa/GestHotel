...
<div class="modal-dialog" style="width: 100%;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h5 class="text-center"><strong>NUEVA RESERVA</strong></h5>
        </div>
        <div class="modal-body">
                            ...
                            foreach ($Habitacion->tipoHabitacion->precio as $rowPrecio) {
                                ...
                                <li class="list-group-item">                                    
                                    <input type="radio" id="id_precio<?php echo $c; ?>" name="id_precio" value="<?php echo $rowPrecio->id; ?>"
                                           title="<?php echo $rowPrecio->monto; ?>" moneda_id="<?php echo $objMon->id; ?>">
            ...
            <div class="form-group">   
                <div class="col-sm-4">
                    ...
                    <div >
                        {{Form::label('descripcion', 'Notas')}}
                        {{ Form::textArea('descripcion','',['class'=>'form-control','size' => '50x7'])}}
                    </div>
                </div>
                <div class="col-sm-8">
