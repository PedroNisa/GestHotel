...
<!-- LISTADO DE SEGUNDO NIVEL DEL MENÚ ADMINISTRACIÓN -->
        ...
        <?php        
        // se muestra si el usuario logueado pertenece a al de un administrador
        ...
        if ($usuario->tipoUsuario->nombre === 'ADMINISTRADOR DE SISTEMA' || $usuario->tipoUsuario->nombre === 'ADMINISTRADOR DE CONTENIDOS') {
            ...
            <li <?php echo (Request::is('administracion/tipo-habitacion/*') || Request::is('administracion/tipo-habitacion')) ? 'class="active"' : ''; ?>>
                <a href="{{URL::to('administracion/tipo-habitacion')}}"><i class="fa fa-plus-square-o" aria-hidden="true"></i>
                    Tipo Habitación</a>
            </li>
         <?php
               }
